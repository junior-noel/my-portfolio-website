            ...
            <div className="space-y-3">
              {messages.map((msg) => (
                <motion.div
                  ...
                  className={`p-4 rounded-2xl border cursor-pointer transition-all duration-200 ${selected?._id === msg._id ? "border-cyan-500/50 bg-cyan-500/5" : "border-gray-800 bg-gray-900 hover:border-gray-700"}`}
                >
                ...
                >
                  ...
                  <div className="flex gap-3 mt-6">
                    <a
                      ...
                      className="flex-1 text-center px-4 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-500 text-white text-sm font-semibold hover:opacity-90 transition-opacity duration-200"
                    >
                      Reply via Email
                    </a>
                    <button
